...
def tbsdvbc():
	LF = open('/storage/downloads/dvb-drivers.txt', 'w')
	LF.write('4.7.6-tbs-dvbc')
	LF.close()
	reboot()

def crazycat():
	LF = open('/storage/downloads/dvb-drivers.txt', 'w')
	LF.write('4.7.6-crazycat')
	LF.close()
	reboot()

def ljalves():
	LF = open('/storage/downloads/dvb-drivers.txt', 'w')
	LF.write('4.7.6-ljalves')
	LF.close()
	reboot()

def ljalvescc():
	LF = open('/storage/downloads/dvb-drivers.txt', 'w')
	LF.write('4.7.6-ljalves-cc')
	LF.close()
	reboot()

def tbs_oss():
	LF = open('/storage/downloads/dvb-drivers.txt', 'w')
	LF.write('4.7.6-tbs-oss')
	LF.close()
	reboot()

def mediabuild():
	LF = open('/storage/downloads/dvb-drivers.txt', 'w')
	LF.write('4.7.6-media_build')
	LF.close()
	reboot()

def dvbsky():
	LF = open('/storage/downloads/dvb-drivers.txt', 'w')
	LF.write('4.7.6-dvbsky')
	LF.close()
	reboot()

def digital_devices():
	LF = open('/storage/downloads/dvb-drivers.txt', 'w')
	LF.write('4.7.6-digital_devices')
	LF.close()
	reboot()

def digital_devices_cc():
	LF = open('/storage/downloads/dvb-drivers.txt', 'w')
	LF.write('4.7.6-digital_devices-cc')
	LF.close()
	reboot()
