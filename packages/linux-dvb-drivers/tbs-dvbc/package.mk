...
post_install() {
  ...
  cp -Pa $INSTALL/usr/lib/modules/$MOD_VER $INSTALL/usr/lib/modules/$MOD_VER-tbsc
  mkdir -p $INSTALL/usr/lib/modules/$MOD_VER-tbsc/updates/tbsc
  find $ROOT/$PKG_BUILD/v4l/ -name \*.ko -exec cp {} $INSTALL/usr/lib/modules/$MOD_VER-tbsc/updates/tbsc \;
  echo "TBS DVBC drivers version: $PKG_VERSION" > $INSTALL/lib/usr/modules/$MOD_VER-tbsc/updates/tbsc-drivers.txt
}
